 ...
 */
export function purgeThreadFromState(state, threadId) {
...
function filterByThread(record, threadId) {
    return Object.fromEntries(Object.entries(record).filter(([, value]) => value.threadId !== threadId));
}
