...
export function isAcv2ProviderKey(value: string): value is Acv2ProviderKey {
  return Object.hasOwn(ACV2_PROVIDER_CAPABILITIES, value);
}

export function acv2ProviderCapabilities(value: string): ProviderCapabilities | undefined {
